...
class AllAudioQuizquestionsRepo {
  ApiClient apiClient;
  AllAudioQuizquestionsRepo({required this.apiClient});

  Future<ResponseModel> getData(int id) async {
    String url = "${UrlContainer.baseUrl}${UrlContainer.audioQuizQuestionsUrl + id.toString()}";
  ...
  Future<ResponseModel> submitAnswer(Map<String, dynamic> map) async {
    String url = '${UrlContainer.baseUrl}${UrlContainer.submitAudioAnswerUrl}';
