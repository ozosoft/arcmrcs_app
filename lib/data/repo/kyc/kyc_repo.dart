...
import '../../model/kyc/kyc_response_model.dart'as prefix;
...
class KycRepo {
  ...
  Future<AuthorizationResponseModel> submitKycData(List<prefix.FormModel> list) async {
  ...
  Future<dynamic> modelToMap(List<prefix.FormModel> list) async {
