...
class Data {
  ...
  Data.fromJson(dynamic json) {
    _generalSetting = json['general_setting'] != null
...
class GeneralSetting {
  ...
  GeneralSetting.fromJson(dynamic json) {
    ...
    _mailConfig = json['mail_config'] != null
        ? MailConfig.fromJson(json['mail_config'])
        : null;
    _smsConfig = json['sms_config'] != null
        ? SmsConfig.fromJson(json['sms_config'])
        : null;
    _firebaseConfig = json['firebase_config'] != null
        ? FirebaseConfig.fromJson(json['firebase_config'])
        : null;
    _globalShortcodes = json['global_shortcodes'] != null
    ...
    _cronRun =
        json['cron_run'] != null ? CronRun.fromJson(json['cron_run']) : null;
...
class SmsConfig {
  ...
  SmsConfig.fromJson(dynamic json) {
    _name = json['name'];
    _clickatell = json['clickatell'] != null
        ? Clickatell.fromJson(json['clickatell'])
        : null;
    _infobip =
        json['infobip'] != null ? Infobip.fromJson(json['infobip']) : null;
    _messageBird = json['message_bird'] != null
        ? MessageBird.fromJson(json['message_bird'])
        : null;
    _nexmo = json['nexmo'] != null ? Nexmo.fromJson(json['nexmo']) : null;
    _smsBroadcast = json['sms_broadcast'] != null
        ? SmsBroadcast.fromJson(json['sms_broadcast'])
        : null;
    _twilio = json['twilio'] != null ? Twilio.fromJson(json['twilio']) : null;
    _textMagic = json['text_magic'] != null
        ? TextMagic.fromJson(json['text_magic'])
        : null;
