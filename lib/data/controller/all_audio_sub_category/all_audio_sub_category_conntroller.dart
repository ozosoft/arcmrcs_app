...
class AllAudioSubCategory extends GetxController {
  AudioSubCategoriesRepo audioSubCategoriesRepo;

  AllAudioSubCategory({required this.audioSubCategoriesRepo});
  ...
  void getdata(String subcategoryId) async {
    ...
    ResponseModel model = await audioSubCategoriesRepo.getData(subcategoryId);
