...
class LocalizationController extends GetxController {
  ...
  List<MyLanguageModel> myLanguages = [
  ...
  List<MyLanguageModel> get myLanguagesData => myLanguages;

  late Locale _locale; // Declare _locale as a late variable

  void _initLocale() {
    _locale = Locale(myLanguages[0].languageCode, myLanguages[0].countryCode);
  }
  ...
  void loadCurrentLanguage() async {
    _locale = Locale(sharedPreferences.getString(SharedPreferenceHelper.languageCode) ?? myLanguages[0].languageCode, sharedPreferences.getString(SharedPreferenceHelper.countryCode) ?? myLanguages[0].countryCode);
