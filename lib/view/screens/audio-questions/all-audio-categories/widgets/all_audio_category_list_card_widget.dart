...
class AllAudioCategoryListTileCardWidget extends StatefulWidget {
  ...
  final AllAudioCategoriesController? controller;
  const AllAudioCategoryListTileCardWidget({super.key, required this.title, this.showLevel = true, this.image = "", this.subCategoryId = "", required this.fromViewAll, this.isExpand = false, required this.index, this.onTap, required this.categoryData, required this.controller});
  @override
  State<AllAudioCategoryListTileCardWidget> createState() => _AllAudioCategoryListTileCardWidgetState();
}

class _AllAudioCategoryListTileCardWidgetState extends State<AllAudioCategoryListTileCardWidget> {
  @override
            ...
            child: InkWell(
              ...
              child: Column(
                ...
                children: [
                  ...
                  widget.fromViewAll
                      ? AllAudioCategoriesExpandedSection(
