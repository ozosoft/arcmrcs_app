...
class AllAudioCategoriesExpandedSection extends StatelessWidget {
  final int categoryindex;
  final bool isExpand;
  final String title;
  final AllAudioCategoriesController? controller;
  const AllAudioCategoriesExpandedSection({super.key, required this.categoryindex, required this.isExpand, required this.title, this.controller});
                  ...
                  return Padding(
                      ...
                      child: InkWell(
                        onTap: () {
                          ...
                          //  Get.toNamed(RouteHelper.audioQuestionScreen, arguments: [title, controller!.allCategoriesList[categoryindex].quizInfos![index].id]);
                          }
                        },
                        child: Container(
