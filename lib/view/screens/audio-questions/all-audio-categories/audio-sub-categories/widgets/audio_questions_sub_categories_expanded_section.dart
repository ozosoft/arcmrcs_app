...
class AudioSectionSubCategoriesLabelSection extends StatelessWidget {
  final int categoryindex;
  final bool isExpand;
  final String title;
  final AllAudioSubCategory? controller;
  const AudioSectionSubCategoriesLabelSection({super.key, required this.categoryindex, required this.isExpand, required this.title, this.controller});
                    ...
                    child: InkWell(
                      onTap: () {
                        if (controller!.subCategoriesList[categoryindex].quizInfos![index].levelStatus == MyStrings.unlock) {
                         ...
                         Get.toNamed(RouteHelper.audioQuestionScreen, arguments: [title, controller!.subCategoriesList[categoryindex].quizInfos![index].id]);
                        }
                      },
                      child: Container(
