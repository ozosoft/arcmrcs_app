...
class _AudioQuestionsSubCategoriesScreenState extends State<AudioQuestionsSubCategoriesScreen> {
  ...
  void initState() {
    ...
    Get.put(AudioSubCategoriesRepo(apiClient: Get.find()));
    Get.put(AllAudioSubCategory(audioSubCategoriesRepo: Get.find()));
    AllAudioSubCategory controller = Get.put(AllAudioSubCategory(audioSubCategoriesRepo: Get.find()));
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AllAudioSubCategory>(
