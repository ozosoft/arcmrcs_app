...
class AudioQuestionsQuizBodySection extends StatefulWidget {
  const AudioQuestionsQuizBodySection({super.key});

  @override
  State<AudioQuestionsQuizBodySection> createState() => _AudioQuestionsQuizBodySectionState();
}

class _AudioQuestionsQuizBodySectionState extends State<AudioQuestionsQuizBodySection> {
  ...
  void initState() {
    ...
    controller.audiosection();
  }

  @override
  Widget build(BuildContext context) {
    return GetBuilder<AudioQuestionsController>(builder: (controller) {
              ...
              : WillPopScope(
                  ...
                  child: PageView.builder(
                    ...
                    onPageChanged: (int page) {
                      ...
                      print("this is audio source >>>>>>>>>>>>>>>>>${controller.audioSource}");
                      print("Audio source for page $page: ${controller.audioSource}");
                      controller.playAudio(controller.audioURL);
                      controller.changePage(page);
                    },
                    itemCount: controller.questionsList.length,
                    itemBuilder: (context, questionsIndex) {
                       controller.audioURL = UrlContainer.baseUrl + controller.questionsList[questionsIndex].audioFile!;
                                ...
                                children: [
                                        ...
                                        child: IconButton(
                                          ...
                                          onPressed: () {
                                            if (controller.isPlaying) {
                                              ...
                                              print("this is asset mp 3${UrlContainer.baseUrl + controller.questionsList[questionsIndex].audioFile!}");
                                             
                                              controller.player.play(AssetSource(controller.audioURL.toString()));
                                            }
                                          },
                                        ),
                                      ),
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(formatTime(controller.position.inSeconds)),
                                        Text(formatTime((controller.duration - controller.position).inSeconds)),
                                      ],
                                    ),
                                  ),
                                  const SizedBox(height: Dimensions.space25),
                                                ...
                                                Expanded(
                                                  child: InkWell(
                                                    onTap: () async {
                                                      ...
                                                      if (controller.allAudioQuizquestionsRepo.apiClient.getSoundStatus()) {
