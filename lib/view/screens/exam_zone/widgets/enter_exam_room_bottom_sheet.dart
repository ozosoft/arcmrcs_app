...
class EnterRoomBottomSheetWidget extends StatefulWidget {
  EnterRoomBottomSheetWidget({super.key});

  @override
  State<EnterRoomBottomSheetWidget> createState() =>
      _EnterRoomBottomSheetWidgetState();
}

class _EnterRoomBottomSheetWidgetState
    extends State<EnterRoomBottomSheetWidget> {
  bool viewAll = false;
 bool agree = false;
  @override
