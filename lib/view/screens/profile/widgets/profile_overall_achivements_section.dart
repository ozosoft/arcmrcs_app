            ...
            Column(
              ...
              children: [
                ...
                GridView.builder(
                    ...
                    shrinkWrap: true,
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 3, childAspectRatio: orientation == Orientation.portrait ? .9 : 2, crossAxisSpacing: Dimensions.space14),
                            ...
                            child: Column(
                              children: [
                                Padding(
                                  ...
                                  child: SvgPicture.asset(MyImages().achivementsType[index].toString()),
                                ),
                                Text(
