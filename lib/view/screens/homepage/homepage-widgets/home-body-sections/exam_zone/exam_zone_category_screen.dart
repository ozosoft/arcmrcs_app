  ...
  Widget build(BuildContext context) {
    return  GetBuilder<DashBoardController>(
      builder: (controller) =>  Column(
        ...
        children: [
         controller.examZonelist !=null?   Padding(
         ...
         controller.examZonelist !=null?  SizedBox(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: Center(
                                               ...
                                               controller.examZonelist[index].point.toString(),
                                              style: regularDefault.copyWith(
                                        ...
                                        Container(
                                          ...
                                          padding: const EdgeInsets.all(
                                              Dimensions.space7),
                                          child: Center(
                                              child: Text( controller.examZonelist[index].winningmark.toString()+MyStrings.markss,
                                                  style: regularDefault.copyWith(
                                                      color: MyColor.colorGrey))),
                                        ),
                                        Container(
                                          ...
                                          margin: const EdgeInsets.all(
                                              Dimensions.space7),
                                          child: Center(
                                              child: Text(controller.examZonelist[index].examDuration.toString()+MyStrings.minutess,
                                                  style: regularDefault.copyWith(
                                                      color: MyColor.colorGrey))),
                                        ),
                                      ],
