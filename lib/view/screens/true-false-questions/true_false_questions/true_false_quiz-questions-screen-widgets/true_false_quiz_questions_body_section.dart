...
class TrueFalseQuizBodySection extends StatefulWidget {
  const TrueFalseQuizBodySection({super.key});

  @override
  State<TrueFalseQuizBodySection> createState() => _TrueFalseQuizBodySectionState();
}

class _TrueFalseQuizBodySectionState extends State<TrueFalseQuizBodySection> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return GetBuilder<TrueFalseQuestionsController>(builder: (controller) {
                                          ...
                                          Expanded(
                                            child: InkWell(
                                              onTap: () async {
                                                ...
                                                if (controller.trueFalseQuestionsRepo.apiClient.getSoundStatus()) {
