...
class TruefalseQuizResultBodySection extends StatefulWidget {
  const TruefalseQuizResultBodySection({super.key});

  @override
  State<TruefalseQuizResultBodySection> createState() => _TruefalseQuizResultBodySectionState();
}

class _TruefalseQuizResultBodySectionState extends State<TruefalseQuizResultBodySection> {
  @override
  void initState() {
