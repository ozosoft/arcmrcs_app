...
import 'package:quiz_lab/view/screens/all-categories/widgets/all_categories_level_section.dart';
import 'package:flutter_svg/svg.dart';
import 'package:get/get.dart';
import 'package:quiz_lab/view/screens/audio-questions/all-audio-categories/widgets/all_audio_categories_level_section.dart';
import 'package:quiz_lab/view/screens/true-false-questions/all-true-false-categories/widgets/all_true_false_categories_level_section.dart';

class AllTrueFalseCategoryListTileCardWidget extends StatefulWidget {
  ...
  final TrueFalseCategoryController? controller;
  const AllTrueFalseCategoryListTileCardWidget({super.key, required this.title, this.showLevel = true, this.image = "", this.subCategoryId = "", required this.fromViewAll, this.isExpand = false, required this.index, this.onTap, required this.categoryData, required this.controller});
  @override
  State<AllTrueFalseCategoryListTileCardWidget> createState() => _AllTrueFalseCategoryListTileCardWidgetState();
}

class _AllTrueFalseCategoryListTileCardWidgetState extends State<AllTrueFalseCategoryListTileCardWidget> {
  @override
            ...
            child: InkWell(
              ...
              child: Column(
                ...
                children: [
                  ...
                  widget.fromViewAll
                      ? AllTrueFalseCategoriesExpandedSection(
