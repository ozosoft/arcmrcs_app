...
class AllTrueFalseCategoriesExpandedSection extends StatelessWidget {
  final int categoryindex;
  final bool isExpand;
  final String title;
  final TrueFalseCategoryController? controller;
  const AllTrueFalseCategoriesExpandedSection({super.key, required this.categoryindex, required this.isExpand, required this.title, this.controller});
                      ...
                      child: InkWell(
                        onTap: () {
                          if (controller!.allCategoriesList[categoryindex].quizInfos![index].levelStatus == MyStrings.unlock) {
                            print(controller!.allCategoriesList[categoryindex].quizInfos![index].id);
                            Get.toNamed(RouteHelper.trueFalseQuestionsSubcategories, arguments: [title, controller!.allCategoriesList[categoryindex].quizInfos![index].id]);
                          }
                        },
                        child: Container(
