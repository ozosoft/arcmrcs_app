...
import 'package:flutter_prime/view/screens/categories/all-categories/widgets/level_list_card.dart';
import 'package:flutter_svg/svg.dart';
import 'package:get/get.dart';
import 'package:flutter_prime/data/model/all_cartegories/all_categories_model.dart';

class AllCategoriesListItem extends StatefulWidget {
  ...
  const AllCategoriesListItem({super.key, required this.levelList, required this.title, this.questions = "", this.image = "", this.subCategoryId = "",  this.fromAllCategory = false, this.isExpand = false, required this.index});
  @override
  State<AllCategoriesListItem> createState() => _AllCategoriesListItemState();
}

class _AllCategoriesListItemState extends State<AllCategoriesListItem> {
  @override
                      ...
                      Row(
                        ...
                        children: [
                          Visibility(
                            ...
                            child: InfoOutlinedCard(
                              text: '${MyStrings.level.tr} ${widget.levelList.length}'
                            ),
                          ),
                          SizedBox(width: widget.subCategoryId != '' ? 0 :Dimensions.space10),
                          InfoOutlinedCard(
                            text: widget.questions + MyStrings.questionse.tr
                          ),
                        ],
                      ),
                    ],
