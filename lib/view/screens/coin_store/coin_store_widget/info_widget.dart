...
class InfoWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CoinStoreController>(builder: (controller) {
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                CustomRow(
                  firstText: MyStrings.transectionCharge.tr,
                  lastText: controller.charge,
                ),
                const Divider(color: MyColor.greyTextColor), const SizedBox(
                  height: 15,
                ),
                CustomRow(
