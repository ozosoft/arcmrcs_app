...
class CustomHeadSection extends StatelessWidget {
  ...
  const CustomHeadSection(
      {super.key,
      this.height = Dimensions.space180,
      this.hasBackButton = true,
      this.iconPosition = Dimensions.space70,
      this.iconHasSize = false,
      this.backbuttonPosition = Dimensions.space65});
