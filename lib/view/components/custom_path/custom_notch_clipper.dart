...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path_0.cubicTo(
        size.width * 0.05207225,
        size.height * 0.01477105,
        size.width * 0.02747253,
        size.height * 0.02799749,
        size.width * 0.02747253,
    ...
    path_0.cubicTo(
        size.width * 0.9725275,
        size.height * 0.02799749,
        size.width * 0.9479286,
        size.height * 0.01477105,
        size.width * 0.9175824,
        size.height * 0.01477105);
    path_0.lineTo(size.width * 0.7197802, size.height * 0.01477105);
    path_0.cubicTo(
        size.width * 0.6646044,
        size.height * 0.01477105,
        size.width * 0.6250495,
        size.height * 0.04041462,
        size.width * 0.6011813,
        size.height * 0.06721832);
    path_0.cubicTo(
        size.width * 0.5799066,
        size.height * 0.09111817,
        size.width * 0.5425412,
        size.height * 0.1019202,
        size.width * 0.5000000,
        size.height * 0.1019202);
    path_0.cubicTo(
        size.width * 0.4574588,
        size.height * 0.1019202,
        size.width * 0.4200934,
        size.height * 0.09111817,
        size.width * 0.3988187,
        size.height * 0.06721832);
    path_0.cubicTo(
        size.width * 0.3749505,
        size.height * 0.04041462,
        size.width * 0.3353901,
        size.height * 0.01477105,
        size.width * 0.2802198,
        size.height * 0.01477105);
